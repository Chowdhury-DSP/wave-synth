...
(
    cd bin
    rm -f "Wave_Synth-Win64-${VERSION}.zip"
    zip -r "Wave_Synth-Win64-${VERSION}.zip" Win64
    # rm -f "Wave_Synth-Win32-${VERSION}.zip"
    # zip -r "Wave_Synth-Win32-${VERSION}.zip" Win32
)
